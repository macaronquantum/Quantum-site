  ...
  if (!connected) {
    return (
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        >
          {/* CTA Banner for disconnected users too */}
          <View style={{ paddingHorizontal: SPACING.lg, paddingTop: SPACING.lg }}>
            <TouchableOpacity 
              style={styles.ctaBanner} 
              onPress={goToPresale}
              activeOpacity={0.85}
              data-testid="cta-presale-banner-disconnected"
            >
              <LinearGradient
...
const styles = StyleSheet.create({
  ...
  connectButton: { borderRadius: BORDER_RADIUS.lg, overflow: 'hidden', width: '100%', maxWidth: 300, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 16, elevation: 8 },
